...
#EDIT THE FOLLOWING:
$toAddress = "tranduong@htduong.com";  //place your/your client's email address here
$toName = "Tran Duong"; //place your client's name here
$website = "htduong.com";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
    ...
    <div>	
        <label>
            Redesign Website:<br /><textarea name="Redesign" cols="36" rows="4" placeholder="Please include a link to the website that needs to be redesign." tabindex="40"></textarea>
        </label>
	</div>
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" cols="36" rows="4" placeholder="Please tell us more about your project!" tabindex="60"></textarea>
		</label>
	</div>	
    <div>	
    <label>
